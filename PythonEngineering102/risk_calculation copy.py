...
if famHistoryIn:
    siblingHistoryIn = bool(input("Do you have any siblings with a history of diabetes (Y/N)? ").upper() == "Y")
    parentHistoryIn = bool(input("Do you have any parents with a history of diabetes (Y/N)? ").upper() == "Y")
...
famHistory = 0
if famHistory:
    if siblingHistoryIn and parentHistoryIn:
        famHistory = 0.753
    else:
        famHistory = 0.728
